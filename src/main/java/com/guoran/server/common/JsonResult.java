...
public class JsonResult implements Serializable {
    ...
    public static String success() {
        return com.guoran.server.common.JsonResult.success(ImErrorCode.MSG_SUCCESS, MessageUtils.get(ImErrorCode.MSG_SUCCESS), null);
    }
    ...
    public static String success(String code, String message, Object data) {
        return JSON.toJSONStringWithDateFormat(new com.guoran.server.common.JsonResult(true, code, message, data), "yyyy-MM-dd HH:mm:ss", SerializerFeature.DisableCircularReferenceDetect, SerializerFeature.WriteNullStringAsEmpty);
    }
    ...
    public static String failed(String code, String msg) {
        return JSON.toJSONString(new com.guoran.server.common.JsonResult(false, code, msg, null));
    }
}
