...
@Api(tags = {""})
@RestController
@RequestMapping("/sys/meterDeparts")
public class MeterDepartResource {
    @Autowired
    MenuService menuService;
    @Autowired
    private MeterDepartService meterDepartService;
    ...
    public String getEntry(@PathVariable long id) {
        String result = null;
        try {
            MeterDepartVM meterDepartVM = meterDepartService.getEntryBy(id);
            result = JsonResult.success(ImErrorCode.MSG_SUCCESS, MessageUtils.get(ImErrorCode.MSG_SUCCESS), meterDepartVM);
    ...
    public String getEntrysByPage(@RequestBody PageQuery pageQuery) {
        ...
        try {
            ...
            Page<MeterDepartVM> pageInfo = meterDepartService.findEntrysByPage(pageQuery);
    ...
    String createEntry(@RequestBody MeterDepartVM meterDepartVM) {
        try {
            meterDepartService.createEntry(meterDepartVM);
    ...
    public String updateEntry(@RequestBody MeterDepartVM meterDepartVM) {
        try {
            meterDepartService.updateEntry(meterDepartVM);
            return JsonResult.success(ImErrorCode.MSG_SUCCESS, MessageUtils.get(ImErrorCode.MSG_SUCCESS), null);
        } catch (ServiceException serviceException) {
            throw serviceException;
        } catch (Exception e) {
    ...
    String deleteEntry(@PathVariable long id) {
        try {
            meterDepartService.deleteById(id);
            return JsonResult.success(ImErrorCode.MSG_SUCCESS, MessageUtils.get(ImErrorCode.MSG_SUCCESS), null);
        } catch (ServiceException serviceException) {
            throw serviceException;
        } catch (Exception e) {
