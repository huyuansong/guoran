...
/**
 * @description: 销售订单编号生成器
 **/
@Component(value = "SALES")
public class SalesOrderGenerator extends CommonCodeGenerator {

    public SalesOrderGenerator(@Autowired MessageUtils messageUtils, @Autowired SequenceService sequenceService) {
    ...
    public String generateCode() {
        ...
        return this.generateCode(4, "SALES");
    }
