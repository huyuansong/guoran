...
/**
 * @description: 验收单据号生成器
 * SCYS+日期+序号
 **/
@Component(value = "ACCEPTANCE")
public class AcceptanceCodeGenerator extends CommonCodeGenerator {

    public AcceptanceCodeGenerator(@Autowired MessageUtils messageUtils, @Autowired SequenceService sequenceService) {
    ...
    public String generateCode() {
        ...
        return this.generateCode(5, "ACCEPTANCE");
    }
