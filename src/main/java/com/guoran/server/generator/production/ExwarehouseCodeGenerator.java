 ...
 * DJCP+日期+序号
 **/
@Component(value = "EX-WAREHOUSE")
public class ExwarehouseCodeGenerator extends CommonCodeGenerator {

    public ExwarehouseCodeGenerator(@Autowired MessageUtils messageUtils, @Autowired SequenceService sequenceService) {
    ...
    public String generateCode() {
        ...
        return this.generateCode(5, "EX-WAREHOUSE");
    }
