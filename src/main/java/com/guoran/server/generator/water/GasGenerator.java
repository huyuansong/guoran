 ...
 **/
@Component(value = "GAS")
public class GasGenerator extends CommonCodeGenerator {

    public GasGenerator(@Autowired MessageUtils messageUtils, @Autowired SequenceService sequenceService) {
    ...
    public String generateCode() {
        return this.generateCode(4, "GAS");
    }
}
