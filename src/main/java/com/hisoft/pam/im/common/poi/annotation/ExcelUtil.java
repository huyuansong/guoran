...
import com.hisoft.pam.im.common.utils.ReflectUtils;
import com.hisoft.pam.im.common.utils.StringUtils;
import com.hisoft.pam.im.common.i18n.MessageUtils;
import com.hisoft.pam.im.common.poi.annotation.Excel.Type;
import com.hisoft.pam.im.common.poi.annotation.Excel.ColumnType;
...
public class ExcelUtil<T>
{
    ...
    public List<T>  importExcel(String sheetName, InputStream is) throws Exception
    {
        ...
        if (sheet == null)
        {
            throw new IOException(MessageUtils.get("file.sheet.not.exist"));
        }
     ...
     * @return 结果
     */
    public String exportExcel(List<T> list, String sheetName,HttpServletResponse response, HttpServletRequest request) throws IOException {
        this.init(list, sheetName, Type.EXPORT);
        return exportExcel(response,sheetName,request);
    }
...
//    }
     ...
     * @return 结果
     */
    public String exportExcel(HttpServletResponse response,String fileName, HttpServletRequest request) throws IOException {
        ...
        try
        {
            fileName = this.codeFileName(request, fileName);
        ...
        catch (Exception e)
        {
            ...
            throw new ServiceException(MessageUtils.get("export.excel.error"));
        }
        finally
        {
            if (wb != null)
    ...
    private String codeFileName(HttpServletRequest request, String fileName) {
        try {
            String agent = request.getHeader("USER-AGENT");  
            String[] ieBrowserArray = {"MSIE","Trident","Edge"};
            if(agent.contains("Firefox")){
                BASE64Encoder base = new BASE64Encoder();
                fileName = "=?utf-8?B?"+base.encode(fileName.getBytes("utf-8"))+"?="+".xlsx";
            }else{
