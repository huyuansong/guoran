...
public class QRCodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String logoPath = "C:\\Users\\user_li\\Desktop\\111\\企业微信截图_15946878094879.png";
        String destPath = "C:\\Users\\user_li\\Desktop\\111";
        System.out.println(QRCodeUtils.encode(text, logoPath, destPath, true));
        //System.out.println(QRCodeUtils.createImage("11111111111",logoPath,true));
